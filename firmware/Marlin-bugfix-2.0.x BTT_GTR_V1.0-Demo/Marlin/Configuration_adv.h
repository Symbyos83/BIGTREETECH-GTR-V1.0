...
//#define LCD_SHOW_E_TOTAL
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN         PI11 // Pin to detect power loss
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       831        // (mA) RMS current. Multiply by 1.414 for peak current.
